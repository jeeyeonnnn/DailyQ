...
class UserTodayReportResponse(BaseModel):
    title: List[str]
    content: List[str]
    ...
    class Config:
        json_schema_extra = {
            "example": {
                "title": [
                    "📊 AI 선생님의 총평",
                    "🌟 균형잡힌 기초 실력, 응용력 향상이 필요하네요! 🌟"
                ],
                "content": [
                    "안녕하세요, 학습자님! 🤗 최초의 인공위성 ‘스푸트니크 1호’를 발사한 나라, ‘청출어람’의 뜻, 물이 어는 온도, 세계보건기구(WHO)의 성격, ‘마부작침’의 의미, ‘해바라기’ 그림의 화가, 대한민국의 통화 단위 등 기본적인 문제들을 잘 해결한 것으로 보아 기본기는 탄탄하신 것 같아요. 👏👏",
                    "하지만, 세계에서 가장 큰 산맥, 세계 3대 박물관에 포함되지 않는 곳, 국제형사재판소(ICC)의 주요 기능 등 조금 더 복잡하고 특별한 문제들에 대해서는 틀린 답변을 선택하셨네요. 😥 이런 부분은 조금 더 깊이 있는 학습이 필요해 보입니다.",
                    "기초적인 문제를 잘 해결하셨으니, 이제는 좀 더 복잡하고 어려운 문제들에 도전해 보시는 것이 어떨까요? 😊 그런 문제들을 해결함으로써 학습자님의 지식 스펙트럼이 넓어질 것이라고 확신합니다! 💪💪",
                    "끊임없는 학습을 통해 학습자님의 능력이 계속 발전하는 것을 기대하겠습니다! 항상 응원하고 있어요. 파이팅! 😃💖"
                ]
            }
        }